		...
		return(
			<div className="menu">
				...
				<ul>
					...
					<li>
						<Link to="/type/create" activeClassName="active" onClick={(e:any)=>{this.toogle(e)}}>Crear tipo de aprendizaje</Link>
					</li>
					<li>
						<Link to="/type" activeClassName="active" onClick={(e:any)=>{this.toogle(e)}}>Ver tipo de aprendizaje</Link>
					</li>
				</ul>
			</div>
		);
