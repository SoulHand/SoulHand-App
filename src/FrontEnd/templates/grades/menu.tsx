		...
		return(
			<div className="menu">
				...
				<ul>
					...
					<li>
						<Link to="/grades/create" activeClassName="active" onClick={(e:any)=>{this.toogle(e)}}>Crear grados</Link>
					</li>
					<li>
						<Link to="/grades" activeClassName="active" onClick={(e:any)=>{this.toogle(e)}}>Ver grados</Link>
					</li>
				</ul>
			</div>
		);
