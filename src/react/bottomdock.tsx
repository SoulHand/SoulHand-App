  ...
  render () {
	...
	<div id="playcall" className="docks hiden" data-align="horizontal-bottom-right" data-transition="ease-out">
     	<ul>
            ...
            <li><a className="icon hand" id="hand" title="Mano.Arrastre hacia la imagen!" href="javascript:void(0);" draggable="false"></a></li>            
            <li><a className="icon profile" id="profile" title="Rostro.Arrastre hacia la imagen!" href="javascript:void(0);" draggable="false"></a></li>            
            <li><a className="icon eje" id="notrack" title="Falso Positivo.Arrastre hacia la imagen!" href="javascript:void(0);" draggable="false"></a></li>            
     	</ul>
    </div>
    );
  }
