...
class People{
	...
	public function create($input){
		...
		$stm->bindValue(':persona_cedula', $input["dni"], PDO::PARAM_STR);
		$stm->bindValue(':persona_nombre', $input["first_name"], PDO::PARAM_STR);
		$stm->bindValue(':persona_apellido', $input["last_name"], PDO::PARAM_STR);
		$stm->bindValue(':persona_telefono', $input["phone"], PDO::PARAM_STR);
		$stm->bindValue(':persona_fecha_nacimiento', $input["birthdate"], PDO::PARAM_STR);
		$stm->bindValue(':persona_correo', $input["email"], PDO::PARAM_STR);
		$query=$stm->execute();
		if(!$query){
