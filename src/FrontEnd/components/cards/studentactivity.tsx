...
import {Link} from 'react-router'
 ...
 export class StudentActivity extends React.Component <Card.student, {}>{
   delete(){
     ajax({
 			method:"DELETE",
      ...
      <div className="demo-cards mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet mdl-grid mdl-grid--no-spacing">
        <div className="demo-updates mdl-card mdl-shadow--2dp mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--12-col-desktop">
          ...
          <div className="mdl-card__actions mdl-card--border">
            <Link to={`/activity/get/${this.props.activity}/student/${this.props.student._id}`} className="mdl-button mdl-js-button mdl-js-ripple-effect">Ver detalles</Link>
          </div>
        </div>
      </div>
     );
