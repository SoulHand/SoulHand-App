...
import {Link} from 'react-router'
 ...
 export class Grade extends React.Component <Card.grade, {}>{
   delete(){
     ajax({
 			method:"DELETE",
 	        url: `${window._BASE}/v1/grades/${this.props.grade._id}?PublicKeyId=${this.props.session.publicKeyId}&PrivateKeyId=${this.props.session.privateKeyId}`,
 	        dataType: "json",
 	        data:null,
 	        crossDomain:true,
      ...
      <div className="demo-cards mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet mdl-grid mdl-grid--no-spacing">
        <div className="demo-updates mdl-card mdl-shadow--2dp mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--12-col-desktop">
          ...
          <div className="mdl-card__supporting-text mdl-color-text--grey-600">
            {this.props.grade.students.length} estudiantes
          </div>
