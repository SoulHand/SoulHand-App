...
import {Menu} from '../app/menu'
 ...
 export class Lexemas extends React.Component <{}, {}>{
                       ...
                       return (
                         <tr key={row._id}>
                           ...
                           <td className="mdl-data-table__cell">
                             <div onClick={this.delete.bind(this, row._id)} id={`view${row._id}`} className="icon material-icons" style={{ cursor: "pointer" }}>delete</div>
