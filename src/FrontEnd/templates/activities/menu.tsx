		...
		return(
			<div className="menu">
				...
				<ul>
					...
					<li>
						<Link to="/activities/create" activeClassName="active" onClick={(e)=>{this.toogle(e)}}>Crear actividad</Link>
					</li>
					<li>
						<Link to="/activities" activeClassName="active" onClick={(e)=>{this.toogle(e)}}>Ver actividad</Link>
					</li>
				</ul>
			</div>
		);
