		...
		return(
			<div className="menu">
				...
				<ul>
					...
					<li>
						<Link to="/periodschools/create" activeClassName="active" onClick={(e)=>{this.toogle(e)}}>Crear Periodo Escolar</Link>
					</li>
					<li>
						<Link to="/periodschools" activeClassName="active" onClick={(e)=>{this.toogle(e)}}>Ver Periodo Escolar</Link>
					</li>
				</ul>
			</div>
		);
