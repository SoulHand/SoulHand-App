		...
		return(
			<div className="menu">
				...
				<ul>
					...
					<li>
						<Link to="/matter/create" activeClassName="active" onClick={(e:any)=>{this.toogle(e)}}>Crear Materia</Link>
					</li>
					<li>
						<Link to="/matter" activeClassName="active" onClick={(e:any)=>{this.toogle(e)}}>Ver Materia</Link>
					</li>
				</ul>
			</div>
		);
